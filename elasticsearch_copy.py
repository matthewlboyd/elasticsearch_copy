...
parser.add_argument('--input', '-i', help='the input source. url of an elasticsearch service or filename')
parser.add_argument('--output', '-o', help='the output source. url of an elasticsearch service or filename')
